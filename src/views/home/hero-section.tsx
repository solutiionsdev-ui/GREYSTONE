...
export const HeroSection = ({ content }: HeroSectionProps) => (
  <section
    ...
    className="relative flex min-h-[100svh] w-full flex-col items-center overflow-hidden bg-[image:var(--backdrop-hero)] px-5 pb-40 pt-28 lg:block lg:h-378.5 lg:px-0 lg:pb-0 lg:pt-0"
  >
    ...
    <h1
      id="hero-heading"
      className="relative z-20 w-full text-center text-title font-light leading-flat text-on-media-muted lg:absolute lg:left-78.75 lg:top-38.5 lg:w-202.5 lg:text-display"
    >
    ...
    <Spring
      ...
      className="relative z-20 mt-6 w-full max-w-152 text-center text-body leading-body text-on-media lg:max-w-none lg:absolute lg:left-113.75 lg:top-84.75 lg:mt-0 lg:w-132.5 lg:text-lead"
    >
      {content.subtitle}
    </Spring>
    ...
    <Spring
      ...
      className="absolute inset-x-5 bottom-12 z-20 text-center text-body leading-body text-on-media lg:inset-x-auto lg:bottom-auto lg:left-126.5 lg:top-341.5 lg:w-107 lg:text-lead"
    >
      {content.caption[0]}
      <br />
      {content.caption[1]}
